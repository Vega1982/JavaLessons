...
public class ThreadsReader {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            while (line != null) {
                // Это чисто для себя, дял контроля, что строки выводятся. Можно закомментить строку кода ниже:
                System.out.println("Пишу строку: " + line);
    ...
    public static String intToString(int nameInc) {
        String stringName = Integer.toString(nameInc);
        return stringName;
    }
